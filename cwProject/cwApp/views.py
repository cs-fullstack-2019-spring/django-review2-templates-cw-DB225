...
def list_songs(request):
    return render(request, 'cwApp/songs.html', {'songs': songs})


def list_song(request, song_id):
    return render(request, 'cwApp/song_details.html', {'current_song': songs[song_id]})


def other_details(request, other_id):
    return render(request, 'cwApp/songBandDetails.html', {'theDetail': songs[other_id]})
